...
class Edit extends \J2t\Rewardpoints\Controller\Adminhtml\Cartpointrules\Quote
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('current_cart_point_rule', $model);
        
        $this->_initAction();
        $this->_view->getLayout()->getBlock('promo_quote_edit')->setData('action', $this->getUrl('rewardpoints_admin/*/save'));
