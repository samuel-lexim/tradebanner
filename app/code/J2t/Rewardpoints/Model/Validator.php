...
class Validator extends \Magento\SalesRule\Model\Validator
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $registry, $collectionFactory, $catalogData, $utility, $rulesApplier, $priceCurrency,
				$validators, $messageManager, $resource, $resourceCollection, $data);
    }
