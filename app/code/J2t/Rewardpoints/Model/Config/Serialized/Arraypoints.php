...
class Arraypoints extends ArraySerialized {
    ...
    //\Magento\Framework\Data\Collection\Db $resourceCollection = null,
            \Magento\Framework\Message\ManagerInterface $messageManager, \Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = []
    ) {
        $this->_design = $design;
    ...
    public function beforeSave() {
        ...
        $arr = array();
        foreach ($value as $key => $val) {
            if (isset($val['min_cart_value']) && isset($val['max_cart_value']) && isset($val['point_value']) && isset($val['group_id']) && isset($val['date_from']) && isset($val['date_end'])) {
