 ...
 */
namespace J2t\Rewardpoints\Block\Adminhtml\Catalogpointrules\Catalog\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('current_point_catalog_rule');
        ...
        $fieldset->addField(
            'title',
            'text',
            ['name' => 'title', 'label' => __('Rule Name'), 'title' => __('Rule Name'), 'required' => true]
        );
        ...
        $this->_eventManager->dispatch('adminhtml_point_catalog_edit_tab_main_prepare_form', ['form' => $form]);
