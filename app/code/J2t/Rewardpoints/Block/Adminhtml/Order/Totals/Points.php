...
namespace J2t\Rewardpoints\Block\Adminhtml\Order\Totals;
...
class Points extends \Magento\Framework\View\Element\Template {
    ...
    //\Magento\Tax\Model\Config $taxConfig,
            PriceCurrencyInterface $priceCurrency, \Magento\Framework\Pricing\Helper\Data $pricingHelper, array $data = []
    ) {
    ...
    protected function _addRewardpoints($after = 'discount') {
        ...
        if (is_object($this->getParentBlock()->getInvoice()) && is_object($discountTotal) && abs($discountTotal->getData('base_value')) && $this->_source->getRewardpointsQuantity()) {
