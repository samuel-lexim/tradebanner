...
class Save extends \Sahy\Banner\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($_FILES['image']['name']) {
                    ...
                    $helper = $this->_objectManager->get('Sahy\Banner\Helper\Data');
                    ...
                    if ($_FILES['image']['name'] != "") {
                        $data['image'] = "banners/" . $_FILES['image']['name'];
                    }
                }
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('sahy_banner/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('sahy_banner/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('sahy_banner/*/new');
                }
                return;
            } catch (\Exception $e) {
