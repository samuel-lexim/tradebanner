...
namespace Eadesigndev\Opicmsppdfgenerator\Controller\Adminhtml\Order\Massaction\Creditmemo;

use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;
use Magento\Framework\App\Filesystem\DirectoryList;
use Magento\Framework\DataObject;
use Magento\Sales\Model\ResourceModel\Order\Shipment\CollectionFactoty;
...
class Printpdf extends \Magento\Sales\Controller\Adminhtml\Order\AbstractMassAction
{
    ...
    protected function massAction(AbstractCollection $collection)
    {
        ...
        $fileName = 'mass_print_pdf_creditmemo' . $date . '.pdf';
