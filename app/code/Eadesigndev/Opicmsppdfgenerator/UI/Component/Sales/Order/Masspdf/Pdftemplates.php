...
class Pdftemplates implements \Zend\Stdlib\JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        ...
        if(!$this->helper->isEnable(\Eadesigndev\Opicmsppdfgenerator\Helper\Data::ENABLE_ORDER)){
            return;
        }
        ...
        if ($this->options === null) {
            ...
            $templateCollection = $this->collectionFactory
                ...
                ->addFieldToFilter('template_type', [
                    'eq' => \Eadesigndev\Opicmsppdfgenerator\Model\Source\TemplateType::TYPE_ORDER
                ])
