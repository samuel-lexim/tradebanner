...
namespace Eadesigndev\Invoicepdfgenerator\Controller\Adminhtml\Variable;

use Eadesigndev\Invoicepdfgenerator\Helper\Variable\DefaultVariables;
...
class Barcodes extends Template
{
    ...
    public function execute()
    {
        ...
        $invoiceVariables = $this->_defaultVariablesHelper->setSourceType($source, $templateTypeName)->getBarcodeDefault($barCodes);
