...
namespace Eadesigndev\Invoicepdfgenerator\Model\Email;

use Magento\Sales\Model\Order\Email\Container\IdentityInterface;
use Magento\Sales\Model\Order\Email\Container\Template;
use Eadesigndev\Invoicepdfgenerator\Helper\Variable\Processors\Output;
use Eadesigndev\Invoicepdfgenerator\Helper\Data;
...
class SenderBuilder extends \Magento\Sales\Model\Order\Email\SenderBuilder
{
    ...
    private function _checkSource($vars)
    {
        ...
        if ($templateId == \Eadesigndev\Invoicepdfgenerator\Controller\Adminhtml\Variable\Template::INVOICE_TMEPLTE_ID) {
            ...
            $template = $this->dataHelper->getTemplateStatus(
                $source,
                \Eadesigndev\Invoicepdfgenerator\Model\Source\TemplateType::TYPE_INVOICE);
