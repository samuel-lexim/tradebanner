...
namespace Eadesigndev\Invoicepdfgenerator\Helper\Variable\Processors;

use Magento\Framework\DataObject;
use Eadesigndev\Invoicepdfgenerator\Helper\AbstractPDF;

/**
 * Class Pdf
 * Process the variable so they are configured for pdf output
 * @package Eadesigndev\Invoicepdfgenerator\Helper
 */
class Pdf extends \Eadesigndev\Invoicepdfgenerator\Helper\AbstractPDF
{
     ...
     * @param \Eadesigndev\Invoicepdfgenerator\Helper\Variable\Formated $formated
     */
    ...
    protected function _transport()
    {
        ...
        $templateTypeName = \Eadesigndev\Invoicepdfgenerator\Model\Source\TemplateType::TYPES[$templateType];
