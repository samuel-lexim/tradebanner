...
namespace Eadesigndev\Invoicepdfgenerator\Helper\Variable\Custom\Items;

use Eadesigndev\Invoicepdfgenerator\Helper\Variable\Custom\AbstractCustomHelper;
    ...
    private function addItemOptitons()
    {
        ...
        if (!empty($result)) {
            ...
            foreach ($result as $option => $value) {
                $label = $value['label'];
                $label = (strtolower($label) == 'width' || strtolower($label) == 'height') ? $label . ' (inches)' : $label;
